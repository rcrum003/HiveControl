...
eval $(curl -s $URL | egrep "(rainofhourly|uvi|AbsPress|RelPress|windir|avgwind|gustspeed|solarrad)" |cut -f 4,14 -d'"' --output-delimiter='=')
eval $(curl -s $URL | egrep "(rainofdaily)" |cut -f 4,12 -d'"' --output-delimiter='=')

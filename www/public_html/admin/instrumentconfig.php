...
<?php
$ttypes = ['temperhum'=>'TemperHum','temper'=>'Temper','dht22'=>'DHT22','dht21'=>'DHT21','sht31d'=>'SHT31-D','bme280'=>'BME280','bme680'=>'BME680','aht20'=>'AHT20','sht41trinkey'=>'SHT41 Trinkey','broodminder'=>'BroodMinder'];
...
?>
        ...
        <div class="temp-option" data-types="sht41trinkey" style="<?= $result['TEMPTYPE'] == 'sht41trinkey' ? '' : 'display:none' ?>">
